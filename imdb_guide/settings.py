# Django settings for imdb_guide project.
import os
import socket
...
SECRET_KEY = '8gb$63@59wps%$h3-umqb@0s&amp;cvt-licqydobtdc)(mhoxsqzo'
...
ROOT_URLCONF = 'imdb_guide.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'imdb_guide.wsgi.application'
