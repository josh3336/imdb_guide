...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Titles.csrftoken'
        db.add_column('titles_titles', 'csrftoken',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Titles.csrftoken'
        db.delete_column('titles_titles', 'csrftoken')
    ...
    models = {
        'titles.titles': {
            ...
            'time_entered': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)', 'null': 'True'}),
