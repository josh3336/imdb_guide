...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Titles.time_entered'
        db.alter_column('titles_titles', 'time_entered', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        'titles.titles': {
            ...
            'time_entered': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)'}),
